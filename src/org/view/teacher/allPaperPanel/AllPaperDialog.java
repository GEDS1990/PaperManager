...
public class AllPaperDialog extends JDialog{
	private static final long serialVersionUID = 1L;
	Paper paper;
	public  AllPaperDialog(Paper paper)
	{   
		this.setModal(true);
		this.paper=paper;
		init();
	...
	private JLabel titleLabel,teacherNameLabel,contentLabel,maxNumberLabel,teachertelLabel,stateLabel;
	private JTextField titleField,teacherNameField,maxNumberField,teachertelField,stateField;
	...
	{    
		...
		stateLabel=new JLabel("发布状态：");
		stateLabel.setBounds(290,140,88,40);
		stateField=new JTextField();
		stateField.setEditable(false);
		stateField.setText(paper.getDepartmentTel());
		stateField.setBounds(388,140,200,30);
