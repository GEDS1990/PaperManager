...
public class SchoolChooseNumTabelPanel extends JPanel implements ActionListener{
	...
	public SchoolChooseNumTabelPanel(Teacher teacher)
	{  
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==flushButton)
		{
			...
			String sql ="select  D_name,M_name,S_class,count(DISTINCT student.S_no) as 人数,sum(case when P_no is null then 1 else null end) as nan from student "
					...
					+ " Group by S_class order by D_name desc,S_class ";
