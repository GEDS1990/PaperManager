...
public class EducationAuditPanel extends JPanel implements ActionListener{
	...
	private EducationAuditTabelPanel tabelPanel;
	

	Object b[] = null;
	Object c[] = null;
	
	public EducationAuditPanel(Education education)
	{
		...
		tabelPanel=new EducationAuditTabelPanel(education);
	...
	public void actionPerformed(ActionEvent e) 
	{
		String sql="select * "
				...
				+ "LEFT JOIN zhuanjia ON paper.Z_no=zhuanjia.Z_no where paper.P_state=0  and ";
