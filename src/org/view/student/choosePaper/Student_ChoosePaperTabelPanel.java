...
import org.view.teacher.allPaperPanel.AllPaperDialog;

public class Student_ChoosePaperTabelPanel extends JPanel implements ActionListener{
	private static final long serialVersionUID = 1L;
	JScrollPane  scrollPanel;
	JTable table;
	DefaultTableModel tableModel;
	Object data[][];
	Object columnNames[]={"论文编号","论文标题","出题教师","限选人数","审核状态"};
	...
	public Student_ChoosePaperTabelPanel(Student student)
	{  
//		teacherNo=teacher.getTeacherNo();
	...
	{   
		...
		maxPageNumber = (int) Math.ceil(tableModel.getRowCount() / pageSize);
...
//			System.out.println(data.length);
		...
		if(e.getSource()==firstPageButton)
		{
			...
			newModel.setColumnIdentifiers(new Object[] {"论文编号","论文标题","出题教师","限选人数","审核状态"});
